...
<script>
    ...
    var kichban = [
        ['Thúy Hiền , tớ có điều muốn nói',' nói đi'],
        ['cậu có thể đã biết hoặc là không biêt' ]
         [ 'tớ đã thích cậu được gần 3 năm rồi ý...']
      ['nên là tớ có đôi điều muốn nói....','Đừng ngại,  cứ nói đi :>']
    ]
    //Thay loiToTinh bằng lời tỏ tình của bạn
    var loiToTinh = 'cậu có thể làm người yêu tớ được không?'
...
<!---
duyvinh21/duyvinh21 is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
